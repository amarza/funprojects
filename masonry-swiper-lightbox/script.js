/*==================== MASONRY JS ====================*/
window.onload = () => {
    const grid = document.querySelector('.chantier__grid')
  
    const masonry = new Masonry(grid, {
        itemSelector: '.chantier__grid-item',
...
/*==================== GSAP ====================*/
gsap.to('.chantier__grid-item img', {
    opacity: 1,
    scale: 1,
    stagger: .1,
    scrollTrigger: {
        trigger: ".chantier__grid-item img",
        // markers: true,
        // start: "top center"
    }
})

/*==================== SINGLE CHANTIER SWIPER ====================*/
let swiper;
window.globals = {};
